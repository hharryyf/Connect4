...
class Board(object):
    ...
    def __init__(self, nrow=6,ncol=7):
        ...
        self.movedict = {}
        self.col = np.zeros(ncol, dtype=int)
        self.piece = np.zeros((nrow, ncol), dtype=int)
        self.lastmove = -1
